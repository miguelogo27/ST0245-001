...
/**
*
* La claseTaller3 tiene como objtivo dar solución a los puntos del taller 3
*
...
public class Taller3 {
    ...
    */    
    ...
    private static void torresDeHannoiAux(int n, int origen, int intermedio, int destino) {
        if (n == 1) {
            System.out.println("El Disco #" + n + " va de " + origen + " a " + destino); 
        } else {
    ...
    */
	...
	int n = 0;
		...
		permutation(prefix , str.substring(0, i) + str.substring( 0 , n));
        }
        }     
    }
